...
Public Class rptDetaProducto
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cocina.rptDetaProducto.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptDetaProducto
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptDetaProducto = New rptDetaProducto()
        rpt.Site = Me.Site
        Return rpt
    End Function
